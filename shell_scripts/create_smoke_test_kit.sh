...
TEST_FILES[coq-extructures~9.0~2025.08]='tests/tutorial.v'
TEST_FILES[coq-extructures~9.1~2026.01]='tests/tutorial.v'
...
PATCH_CMDS[coq-hott~9.0~2025.08]='/^Require Import$/ {print "From HoTT "$0; next}'
PATCH_CMDS[coq-hott~9.1~2026.01]='/^Require Import$/ {print "From HoTT "$0; next}'
...
TEST_FILES[coq-mathcomp-word~9.0~2025.08]='../../test_files/coq-mathcomp-word/test.v'
...
TEST_FILES[coq-simple-io~9.0~2025.08]='test/example/main.v test/extraction/main.v'
TEST_FILES[coq-simple-io~9.1~2026.01]='test/example/main.v test/extraction/main.v'
