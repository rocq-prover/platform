...
TEST_FILES[coq-extructures~9.0+beta~2025.05]='tests/tutorial.v'
...
PATCH_CMDS[coq-hott~9.0+beta~2025.05]='/^Require Import$/ {print "From HoTT "$0; next}'
...
TEST_FILES[coq-mathcomp-word~9.0+beta~2025.05]='../../test_files/coq-mathcomp-word/test.v'
...
TEST_FILES[coq-riscv~9.0+beta~2025.05]='src/riscv/Examples/Fib.v'
...
TEST_FILES[coq-simple-io~9.0+beta~2025.05]='test/example/main.v test/extraction/main.v'
