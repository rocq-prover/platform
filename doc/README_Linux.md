...
- Use the following commands to activate this switch after opening a new shell:
  - `opam switch CP.2025.08.1~9.0~2025.08` (note: the switch name might vary if you choose a different version of Rocq - please use `opam switch` to see a list of switch names)
  - `eval $(opam env)`
