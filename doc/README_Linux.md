...
- The script creates a new opam switch named e.g. CP.2025.08.0~9.0~2025.08 - the exact name depends on the Coq version and package pick you selected.
...
- Use the following commands to activate this switch after opening a new shell:
  - `opam switch CP.2025.08.0~9.0~2025.08` (note: the switch name might vary if you choose a different version of Coq - please use `opam switch` to see a list of switch names)
  - `eval $(opam env)`
